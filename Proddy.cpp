...
void log()
{
    ...
    ofstream file("ProddyApp.txt", ios::app);
...
void retrive()
{
    if (total != 0)
    {
        for (int i = 0; i < total; i++)
        {
            cout << "\n\t---TODAY PLANS---" << endl;
            cout << "\nTodays Date: " << pro[i].date << endl;
            cout << "Time: " << pro[i].time << endl;
            cout << "Working On: " << pro[i].work << endl;
            cout << "Topic: " << pro[i].topic << endl;
            cout << "Hours: " << pro[i].hours << endl;
            workhours = workhours + pro[i].hours;
            cout << "Feelings & Learning: " << pro[i].plans << endl;
